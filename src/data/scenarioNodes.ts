...
const BALTIC: TheaterNetwork = {
  ...
  nodes: [
    ...
    { id:'PORT_TAL', name:'Port of Tallinn',       short:'SPOD-TAL', type:'circle',  nodeType:'SEAPORT',     lat:59.4485, lng:24.7722, unitId:null, maritime:true },
    ...
    { id:'ASP_TAR',  name:'ASP Tartu',              short:'ASP-TAR', type:'diamond', nodeType:'ASP',         lat:58.4200, lng:26.6800, unitId:null               },
    { id:'FARP_SIA', name:'FARP Siauliai',          short:'FARP-SIA',type:'square',  nodeType:'FARP',        lat:55.9800, lng:23.2600, unitId:null               },
...
const DESERT: TheaterNetwork = {
  ...
  nodes: [
    ...
    { id:'FOB_RTB',  name:'FOB Iron (Rutbah)',       short:'FOB-I',   type:'circle',  nodeType:'FOB',         lat:33.0200, lng:40.3100, unitId:'FOB1'             },
  ...
  locs: [
    ...
    { id:'l03', from:'ASP_AZR',  to:'FOB_RTB',  type:'GROUND', status:'ACTIVE',      cargo:'CL III',    threat:'HIGH'   },
    ...
    { id:'l07', from:'DEP_BGW',  to:'FOB_MSL',  type:'GROUND', status:'ACTIVE',      cargo:'CL III',    threat:'HIGH'   },
...
const SAND_BRIDGE: TheaterNetwork = {
  ...
  nodes: [
    ...
    { id:'PORT_AUH', name:'Port of Abu Dhabi',       short:'SPOD-AUH', type:'circle',  nodeType:'SEAPORT',     lat:24.5100, lng:54.3800, unitId:null, maritime:true },
    ...
    { id:'FOB_ARZ',  name:'FOB Eagle (Camp Udairi)', short:'FOB-E',   type:'circle',  nodeType:'FOB',         lat:29.3500, lng:47.3500, unitId:'FOB3'             },
...
const PACIFIC_PUSH: TheaterNetwork = {
  ...
  nodes: [
    ...
    { id:'AVN_OSN',  name:'Aviation BDE (Osan)',      short:'AVN',     type:'circle',  nodeType:'AIRFIELD',    lat:37.1200, lng:127.0700, unitId:'AVN_BDE'          },
  ],
  locs: [
...
const ISLAND_HOP: TheaterNetwork = {
  ...
  nodes: [
    ...
    { id:'FARP_TIN', name:'FARP Tinian',              short:'FARP-TIN',type:'square',  nodeType:'FARP',        lat:15.0500, lng:145.6400, unitId:null               },
